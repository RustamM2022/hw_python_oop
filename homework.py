...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        get_spent_calories: int = (coeff_calorie_1 * self.get_mean_speed() - coeff_calorie_2) \
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        get_spent_calories: int = (coeff_calorie_3 * self.weight +(self.get_mean_speed()**2 // self.height) \
            * coeff_calorie_4 * self.weight) * 60 * self.duration
        return get_spent_calories
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        get_spent_calories: float = (self.get_mean_speed() + coeff_calorie_5) * coeff_calorie_6 \
            * self.weight
        return get_spent_calories
