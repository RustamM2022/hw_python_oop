...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        get_spent_calories:int = (coeff_calorie_1 * self.get_mean_speed() - coeff_calorie_2) * self.weight / self.M_IN_KM * 60 * self.duration 
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        get_spent_calories:int = (coeff_calorie_3 * self.weight +(self.get_mean_speed()**2 // self.height) * coeff_calorie_4 * self.weight) * 60 * self.duration 
        return get_spent_calories
...
class Swimming(Training):
    ...
    """Получить среднюю скорость движения."""
    def get_mean_speed(self) -> float:
        get_mean_speed = self.length_pool * self.count_pool / self.M_IN_KM / self.duration
        return get_mean_speed
    ...
    def get_spent_calories(self) -> float:
        ...
        get_spent_calories:float = (self.get_mean_speed() + coeff_calorie_5) * coeff_calorie_6 * self.weight 
        return get_spent_calories 
